...
y = df[['target']]
y = y.values.ravel()
ACC_arr_test, clinic_ACC_arr_train, clinic_ACC_arr_test, EEG_ACC_arr_train, EEG_ACC_arr_test = LR_model(X, y)
...
y = df[['target']]
y = y.values.ravel()
ACC_arr_test, clinic_ACC_arr_train, clinic_ACC_arr_test, EEG_ACC_arr_train, EEG_ACC_arr_test = LR_model(X, y,i)
